...
)](scripts/setlistfm-musicbrainz-import/setlistfm-musicbrainz-import.user.js?raw=1)
...
)](src/setlistfm-musicbrainz-import/app.ts)

This scripts allows you to import set lists from [setlist.fm](https://setlist.fm) as MusicBrainz events.

![setlist.fm importer](src/setlistfm-musicbrainz-import/setlistfm_importer.png?raw=1)
...
![ACUM importer](src/acum-work-import/acum-work-import.png?raw=1)
