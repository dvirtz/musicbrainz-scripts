...
export const RECORDING_OTHER_DATABASE_LINK_TYPE_ID = 306;
export const RELEASE_GROUP_OTHER_DATABASE_LINK_TYPE_ID = 96;
export const SERIES_HELD_AT_RELATIONSHIP_TYPE_ID = 995;
export const TRANSLATOR_LINK_TYPE_ID = 872;
export const WORK_OTHER_DATABASE_LINK_TYPE_ID = 273;
