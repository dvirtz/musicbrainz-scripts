...
The script adds two buttons under the tracklist: `Remove LHS` and `Remove RHS`. Clicking either button will remove the corresponding language from all track titles and artist credits.

![before](assets/before.png)

after clicking `Remove LHS`:
...
```shell
yarn workspace @dvirtz/single-language-tracklist dev
```

Run tests:

```shell
yarn workspace @dvirtz/single-language-tracklist test
```
